...
class Student:
    def __init__(self,root):
        ...
        first_lb.place(x=450,y=0,width=500,height=130)
        ...
        first_lb.place(x=950,y=0,width=500,height=130)
        ...
        bg=bg.resize((1366,768),Image.ANTIALIAS)   #High level img to Low level img
        self.photoimg_bg=ImageTk.PhotoImage(bg)

        bg_image=Label(self.root, image=self.photoimg_bg)
        bg_image.place(x=0,y=130,width=1366,height=768)
        ...
        img_lf=img_lf.resize((685,100),Image.ANTIALIAS)   #High level img to Low level img
        self.photoimg_lf=ImageTk.PhotoImage(img_lf)

        first_lb=Label(left_frame, image=self.photoimg_lf)
        first_lb.place(x=5,y=0,width=685,height=100)
        ...
        current_course_frame.place(x=5,y=105,width=690,height=110)
        ...
        class_student_frame.place(x=5,y=215,width=690,height=287)
        ...
        studentName_entry=ttk.Entry(class_student_frame,textvariable=self.var_std_name,width=18,font=("time new roman",12,"bold"))
        ...
        studentGender_combo=ttk.Combobox(class_student_frame,textvariable=self.var_gender,state="readonly",font=("time new roman",12,"bold"),width=16)
        ...
        address_entry=ttk.Entry(class_student_frame,textvariable=self.var_add,width=18,font=("time new roman",12,"bold"))
        address_entry.grid(row=2,column=3,padx=10,pady=5,sticky=W)
       
       
        # Father/Gardian Name
        Father_Gardian_Name=Label(class_student_frame,text="Father/Guardian:",font=("time new roman",12,"bold"),bg="#f0ecdf")
        ...
        DOB=ttk.Entry(class_student_frame,textvariable=self.var_dob,width=18,font=("time new roman",12,"bold"))
        DOB.grid(row=3,column=3,padx=10,pady=5,sticky=W)
       
        # Eno
        Eno=Label(class_student_frame,text="Enrollment:",font=("time new roman",12,"bold"),bg="#f0ecdf")
        ...
        Mentor=ttk.Entry(class_student_frame,textvariable=self.var_mentor,width=18,font=("time new roman",12,"bold"))
        ...
        btn_frame.place(x=2,y=205,width=680,height=30)

        #Save btn
        save_btn=Button(btn_frame,text="Save",command=self.add_data,width=19,font=("time new roman",8,"bold"),bg="blue",fg="white")
        save_btn.grid(row=0,column=0,padx=15,pady=1)

        #Update btn
        update_btn=Button(btn_frame,text="Update",command=self.update_data,width=19,font=("time new roman",8,"bold"),bg="blue",fg="white")
        update_btn.grid(row=0,column=1,padx=10,pady=1)

        #Delete btn
        delete_btn=Button(btn_frame,text="Delete",command=self.delete_data,width=19,font=("time new roman",8,"bold"),bg="blue",fg="white")
        delete_btn.grid(row=0,column=2,padx=10,pady=1)

        #Reset btn
        Reset_btn=Button(btn_frame,text="Reset",command=self.reset_data,width=19,font=("time new roman",8,"bold"),bg="blue",fg="white")
        Reset_btn.grid(row=0,column=3,padx=15,pady=1)

        # Second Button Frame
        btn_frame_2=LabelFrame(class_student_frame,bd=2,bg="#f0ecdf",relief=RIDGE)
        btn_frame_2.place(x=2,y=235,width=680,height=28)

        #take photo btn
        take_photo_btn=Button(btn_frame_2,text="Take Photo",command=self.generate_dataset,width=92,font=("time new roman",8,"bold"),bg="blue",fg="white")
        take_photo_btn.grid(row=0,column=0,padx=10,pady=1)

        #Update photo btn
        #update_photo_btn=Button(btn_frame_2,text="Update Photo",width=43,font=("time new roman",8,"bold"),bg="blue",fg="white")
        #update_photo_btn.grid(row=0,column=1,padx=10,pady=1)
        ...
        right_frame.place(x=720,y=10,width=620,height=530)

        img_rt=Image.open("Images/attendance2.jpg")
        img_rt=img_rt.resize((605,100),Image.ANTIALIAS)   #High level img to Low level img
        self.photoimg_rf=ImageTk.PhotoImage(img_rt)

        first_lb=Label(right_frame, image=self.photoimg_rf)
        first_lb.place(x=5,y=0,width=605,height=100)
        ...
        Search=Label(search_frame,text="Search:",font=("time new roman",12,"bold"),bg="#f0ecdf",fg="red")
        Search.grid(row=0,column=0,padx=10,pady=2,sticky=W)

        search_combo=ttk.Combobox(search_frame,font=("time new roman",10,"bold"),state="readonly",width=12)
        ...
        search_entry=ttk.Entry(search_frame,width=25,font=("time new roman",10,"bold"))
        search_entry.grid(row=0,column=2,padx=10,pady=2,sticky=W)

        search_btn=Button(search_frame,text="Search",width=10,font=("time new roman",10,"bold"),bg="blue",fg="white")
        search_btn.grid(row=0,column=3,padx=5)
        
        showAll_btn=Button(search_frame,text="Show All",width=10,font=("time new roman",10,"bold"),bg="blue",fg="white")
        showAll_btn.grid(row=0,column=4,padx=5)

        #Table Frame

        Table_frame=Frame(right_frame,bd=2,bg="#f0ecdf",relief=RIDGE)
        Table_frame.place(x=5,y=165,width=610,height=340)
        ...
        self.student_table.heading("Mentor",text="Teacher")
        ...
        self.student_table.column("Student_Email",width=200)
        ...
        self.student_table.column("Name(F/G)",width=200)
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_course.get()=="Select Course" or self.var_year.get()=="Select Year" or self.var_sem.get()=="Select Semester" or self.var_std_id.get()=="" or self.var_std_name.get()=="" or self.var_std_email.get()=="" or self.var_gender.get()=="Select Gender" or self.var_dob.get()=="" or self.var_ForG.get()=="" or self.var_add.get()=="" or self.var_phone_no.get()=="" or self.var_roll.get()=="" or self.var_mentor.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host='localhost',username='root',password='vabhu886vabhu@',database='face_recognition')
