...
class Face_Recognition:
    def __init__(self,root):
        ...
        title_lbl=Label(self.root,text="FACE RECOGNITION",font=("times new roman",35,"bold"),bg="blue",fg="red")
        title_lbl.place(x=0,y=0,width=1366,height=45)

        #1st image
        img_top=Image.open("Images/face_recog1.jpg")
        img_top=img_top.resize((683,708),Image.ANTIALIAS)
        self.photoimg_top=ImageTk.PhotoImage(img_top)

        f_lbl=Label(self.root,image=self.photoimg_top)
        f_lbl.place(x=0,y=50,width=683,height=708)

        #2nd image
        img_bottom=Image.open("Images/face_recog2.jpg")
        img_bottom=img_bottom.resize((683,715),Image.ANTIALIAS)
        self.photoimg_bottom=ImageTk.PhotoImage(img_bottom)

        f_lbl=Label(self.root,image=self.photoimg_bottom)
        f_lbl.place(x=683,y=50,width=683,height=715)
        ...
        b1_1.place(x=235,y=630,width=200,height=40)
