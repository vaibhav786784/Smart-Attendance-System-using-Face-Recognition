...
class login_page:
    def __init__(self, root):
        ...
        self.window.geometry("1266x768+0+0")
        ...
        self.frame1.place(x=0, y=0, width=450, height =768)

        label1 = Label(self.frame1, font=("times new roman", 40, "bold"), bg="yellow", fg="red").place(x=100,y=300)
        label2 = Label(self.frame1, font=("times new roman", 40, "bold"), bg="yellow", fg="RoyalBlue1").place(x=162,y=300)
        label3 = Label(self.frame1, font=("times new roman", 13, "bold"), bg="yellow", fg="brown4").place(x=100,y=360)

        #=============Entry Field & Buttons============

        self.frame2 = Frame(self.window, bg = "gray95")
        self.frame2.place(x=450,y=0,width=916, height=768)

        self.frame3 = Frame(self.frame2, bg="white")
        self.frame3.place(x=140,y=150,width=420,height=400)

        self.email_label = Label(self.frame3,text="Email", font=("helvetica",20,"bold"),bg="white", fg="gray").place(x=50,y=40)
        ...
        self.forgotten_pass = Button(self.frame3,text="Forgot password?",command=self.forgot_func,font=("times new roman",10, "bold"),bd=0,cursor="hand2",bg="white",fg="blue").place(x=125,y=260,width=150)
    ...
    def login_func(self):
        if self.email_entry.get()=="" or self.password_entry.get()=="":
            ...
            try:
                connection=pymysql.connect(host="localhost",user="root",password="vabhu886vabhu@",database="student_database")
                ...
                if row == None:
                    ...
                    messagebox.showinfo("Success","Access only authority Person",parent=self.window)
                    self.window.destroy()
