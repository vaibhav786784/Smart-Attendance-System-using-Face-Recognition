...
class SignUp:
    def __init__(self, root):
        ...
        self.terms = IntVar()
        terms_and_con = Checkbutton(frame,text="I Agree The Terms & Conditions",variable=self.terms,onvalue=1,offvalue=0,bg="white",font=("times new roman",12)).place(x=20,y=400)

        self.signup = Button(frame,text="Sign Up",command=self.signup_func,font=("times new roman",18, "bold"),bd=0,cursor="hand2",bg="green2",fg="white").place(x=120,y=440,width=250)

        self.login_button = Button(frame, text="Log In", command=self.redirect_window,
                               font=("times new roman", 18, "bold"), bd=0, cursor="hand2", bg="blue", fg="white").place(
